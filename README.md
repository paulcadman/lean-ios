...
It also includes a minimal example iOS app that demonstrates how a Lean function
can be called from an iOS app:
...
- `make sim-app` - builds example-app for iOS simulator
- `make run-sim-app` - starts a simulator, deploys / runs the iOS example app
